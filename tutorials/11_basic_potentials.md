...
```python
# Set this to the pre-run simulation directory
sim_dir = "/anvil/projects/x-chm250117/tutorials/tutorial11/part1_argon"
...
```python
import os
os.chdir("/anvil/projects/x-chm250117/tutorials/tutorial11/part1_argon")
...
:::{dropdown} Why ASE? (Click to expand)
**Professional Tool:**
...
:::{dropdown} SLURM Job Script (for running yourself later)
```bash
#!/bin/bash
#SBATCH -A chm250117
#SBATCH -p shared
...
cp /anvil/projects/x-chm250117/class_examples/tutorial11_completed/part1_argon/argon_lj.log .
```

Or analyze directly from the shared directory by setting the path in your notebook.
...
- Verify you have read access: `ls -l /anvil/projects/x-chm250117/class_examples/tutorial11_completed/part1_argon/`
:::
...
ls /anvil/projects/x-chm250117/class_examples/tutorial11_completed/part2_nitrogen/lj_only/
```
...
```bash
ls /anvil/projects/x-chm250117/class_examples/tutorial11_completed/part2_nitrogen/n2_system.data
```

:::{dropdown} Python Script to Build N₂ System (for reference)
```python
from ase.build import molecule
import numpy as np
...
ls /anvil/projects/x-chm250117/class_examples/tutorial11_completed/part2_nitrogen/n2.lammpstrj
```
...
**Notebook Cell 2: Python Analysis from Trajectory**
...
```bash
ls /anvil/projects/x-chm250117/class_examples/tutorial11_completed/part3_ethane/ethane.data
```

:::{dropdown} Python Script to Build Ethane (for reference)
```python
from ase.build import molecule
import numpy as np
...
```bash
ls /anvil/projects/x-chm250117/class_examples/tutorial11_completed/part3_ethane/ethane.lammpstrj
```
